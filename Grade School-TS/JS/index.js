...
console.log("1.", JSON.stringify(school.roster()) === JSON.stringify(expectedDb));
school = new GradeSchool();
school.add("Chelsea", 3);
school.add("Logan", 7);
expectedDb = { 3: ["Chelsea"], 7: ["Logan"] };
console.log("2.", JSON.stringify(school.roster()) === JSON.stringify(expectedDb));
school = new GradeSchool();
school.add("Franklin", 5);
school.add("Bradley", 5);
school.add("Jeff", 1);
console.log("3.", JSON.stringify(school.grade(5)) === JSON.stringify(["Bradley", "Franklin"]));
school = new GradeSchool();
...
console.log("4.", JSON.stringify(school.roster()) === JSON.stringify(expectedDb));
school = new GradeSchool();
school.add("Aimee", 2);
const roster = school.roster();
roster[2].push("Oops.");
expectedDb = { 2: ["Aimee"] };
console.log("5.", JSON.stringify(school.roster()) === JSON.stringify(expectedDb));
school = new GradeSchool();
school.add("Aimee", 2);
school.grade(2).push("Oops.");
expectedDb = { 2: ["Aimee"] };
console.log("6.", JSON.stringify(school.roster()) === JSON.stringify(expectedDb));
school = new GradeSchool();
school.add("Aimee", 2);
school.add("Aimee", 1);
expectedDb = [];
console.log("7.", JSON.stringify(school.grade(2)) === JSON.stringify(expectedDb));
school = new GradeSchool();
let inputCodes = `
school.add("Aimee", 2);
school.grade(2).push("Oops.");
