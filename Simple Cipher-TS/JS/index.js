...
class Cipher {
    ...
    encode(input) {
        ...
        for (let i = 0; i < input.length; i++) {
            let charCode = input.charAt(i).charCodeAt(0) +
    ...
    noKeyGiven(inputLength) {
        for (let i = 0; i < inputLength; i++) {
            this.keyValue += String.fromCharCode(Math.trunc(Math.random() * 26) + 97);
        }
    }
...
console.log(new Cipher("iamapandabear").encode("iamapandabear") === "qayaeaagaciai");
